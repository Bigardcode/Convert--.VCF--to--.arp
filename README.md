...
# Step 1 
Check the VCF file to make suere that is in corrected format
# Step 2 
Covert the VCF file into CSV
# Step 3 
Make sure you sort your individuals by population so that they are all grouped together
# Step 4
Install python tools on ubuntu 
# Step 5
Run the command to convert .VCF file to .arp file
